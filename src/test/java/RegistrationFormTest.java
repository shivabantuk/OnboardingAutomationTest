...
public class RegistrationFormTest {
    ...
    public void testEmptyFields() {
        ...
        Assert.assertTrue(errorMessage.getText().contains("Please fill in all fields"), "Incorrect error message");
    }
    ...
    public void testInvalidUsername() {
        ...
        driver.findElement(By.id("username")).sendKeys("jane"); // Username too short
        driver.findElement(By.id("password")).sendKeys("password123");
        driver.findElement(By.xpath("//button[@type='submit']")).click();

        WebElement errorMessage = driver.findElement(By.xpath("//div[contains(@class, 'alert-danger')]"));
        Assert.assertTrue(errorMessage.isDisplayed(), "Error message is not displayed");
        Assert.assertTrue(errorMessage.getText().contains("Username must be at least 5 characters"), "Incorrect error message");
    }

    @Test(testName = "TC004_InvalidPassword")
    public void testInvalidPassword() {
        ...
        driver.findElement(By.id("password")).sendKeys("pass"); // Password too short
        driver.findElement(By.xpath("//button[@type='submit']")).click();

        WebElement errorMessage = driver.findElement(By.xpath("//div[contains(@class, 'alert-danger')]"));
        Assert.assertTrue(errorMessage.isDisplayed(), "Error message is not displayed");
        Assert.assertTrue(errorMessage.getText().contains("Password must be at least 8 characters"), "Incorrect error message");
    }
