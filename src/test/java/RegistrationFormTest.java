...
public class RegistrationFormTest {
    ...
    public void testInvalidUsername() {
        ...
        WebElement usernameError = driver.findElement(By.id("username-error"));
        Assert.assertTrue(usernameError.isDisplayed(), "Username error should be displayed");
        Assert.assertEquals(usernameError.getText(), "Username must be at least 6 characters long", "Incorrect username error message");
    }
    ...
    public void testWeakPassword() {
        ...
        driver.findElement(By.id("username")).sendKeys("alic create a pull request targeting a main branch with the Certainly! I'll provide you with a sample Java + Selenium + TestNG automated test script for the Registration Form on the given URL. This script will include both functional and negative test cases, along with setup and teardown methods.

Here's the automated test script:
